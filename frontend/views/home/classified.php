                        ...
                        foreach ($data as $row) {
                            ...
                            <li class="clearfix">
                                ...
                                <?php foreach ($dataImg as $dataImg) { ?>
                                    <div class="col-sm-2"> <a class="thumbnail" href="detail.html"><img src="<?php echo $dataImg['image'] ?>" alt=""></a>
                                ...
                                <div class="col-sm-8">
                                    <h3><a class="title" href="<?= Yii::$app->urlManager->createUrl(['classified/view', 'id' => $row['id']]) ?>"><?= $row['title'] ?> </a></h3>
                        ...
                        foreach ($data as $row) {
                            ...
                            <li class="col-sm-4">
                                ...
                                <div class="searchgrid"> 
                                    <?php foreach ($dataImg as $dataImg) { ?>
                                        <a class="thumbnail" href="detail.html"><img src="<?php echo $dataImg['image'] ?>" alt=""></a>
                                    <?php } ?>
                                    <div>
                                        <h3><a class="title" href="<?= Yii::$app->urlManager->createUrl(['classified/view', 'id' => $row['id']]) ?>"><?= $row['title'] ?> </a></h3>
                                        <?php if ($row['is_status'] == 0) { ?>
