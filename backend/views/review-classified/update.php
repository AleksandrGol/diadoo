                    ...
                    <div class="box-body">
                        <?php if ($modelClassified->type == 1) { ?>
                            ...
                            <?php foreach ($dataUser as $dataUser) { ?>
                                ...
                                <div>
                                    <a href="http://localhost/ta/diadoo/frontend/web/index.php?r=home%2Findex&id=<?= $dataUser['id'] ?>" target="_blank" class="btn btn-sm bg-orange btn-flat no-margin pull-right">Go to my page <i class="fa fa-arrow-circle-o-right"></i></a>
                                </div>
                            <?php } ?>
