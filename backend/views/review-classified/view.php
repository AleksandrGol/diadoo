                        ...
                        <div class="box-body">
                            <?php if ($dataView['type'] == 1) { ?>
                                ...
                                $queryUser->select([
                                        ...
                                        ->from('user')
                                        ->join('JOIN', 'profile', 'profile.user_id = user.id')
                                ...
                                <?php foreach ($dataUser as $dataUser) { ?>
                                    <img src="<?= Yii::getAlias('@urlFrontend') . '/' . $dataUser['image_profile'] ?>" class="img-thumbnail">
                                    <div style="margin-top: 5px; text-align: center">
                                        <p><b><?= $dataUser['username'] ?></b></p>
                                    </div>
                                    <div>
                                        Location : <?= $dataUser['city'] ?>, <?= $dataUser['region'] ?>, <?= $dataUser['country'] ?>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        Public Email : 
                                        <?php
                                        if ($dataUser['public_email'] == null) {
                                            echo "<i>Not set</i>";
                                        } else {
                                            echo $dataUser['public_email'];
                                        }
                                        ?>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <a href="http://localhost/taskripsi/depi/diadoo/frontend/web/index.php?r=home%2Findex&id=<?= $dataUser['id'] ?>" target="_blank" class="btn btn-sm bg-orange btn-flat no-margin pull-right">Go to my page <i class="fa fa-arrow-circle-o-right"></i></a>
                                    </div>
                                <?php } ?>
